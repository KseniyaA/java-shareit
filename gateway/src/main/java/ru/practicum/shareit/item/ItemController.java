...
public class ItemController {
    ...
    public ResponseEntity<Object> getAllByUser(@RequestHeader("X-Sharer-User-Id") long userId,
                                               /*@RequestParam(required = false) @ValidateFromIfPresent*/@PositiveOrZero @RequestParam(name = "from", defaultValue = "0") Integer from,
                                               /*@RequestParam(required = false) @ValidateFromIfPresent*/@Positive @RequestParam(name = "size", defaultValue = "10") Integer size) {
